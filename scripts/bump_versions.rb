...
podspec_path = "./IONFileTransferLib.podspec"
...
LIBRARY_NAME = "IONFileTransferLib"
...
new_readme_content = readme_content.gsub(/(pod 'IONFileTransferLib', '~> )\d+\.\d+\.\d+/, "\\1#{new_version_number}\\2")
